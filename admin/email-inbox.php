                    ...
                    <div class="card-body">
                        <div class="email-left-box">
                            <div class="mail-list mt-4">
                                ...
                                <form method="POST" action="delete-inquiries.php"> <!-- Form for deleting emails -->
                                    <button type="submit" class="list-group-item border-0 p-r-0" name="delete" >
                        ...
                        <div class="email-right-box">
                            <div class="email-list m-t-15">
                                <?php
                                // Fetch data from the service_inquiries table
                                $sql = "SELECT id, first_name, last_name, email, service_type, created_at 
                                ...
                                if ($result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        $serviceType = htmlspecialchars($row['service_type'], ENT_QUOTES, 'UTF-8'); // Added service type
                                        $time = htmlspecialchars(date("g:i a", strtotime($row['created_at'])), ENT_QUOTES, 'UTF-8');
                                ?>
                                <div class="message">
                                    <a href="email-read.php?id=<?php echo $row['id']; ?>">
                                        <div class="col-mail col-mail-1">
                                            <div class="email-checkbox">
                                                <input type="checkbox" name="email_ids[]" value="<?php echo $row['id']; ?>">
                                        ...
                                        <div class="col-mail col-mail-2">
                                            <div class="subject">
                                                <strong><?php echo $fullName; ?></strong> - <?php echo $serviceType; ?>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="btn-group float-right">
                                        <button class="btn btn-gradient" type="button"><i class="fa fa-angle-left"></i></button>
